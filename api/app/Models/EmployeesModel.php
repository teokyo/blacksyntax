...
//              print_r('entro');
            ...
            return array('success'=>true, 'description'=>'The admins were found','result'=>array_merge($result[0],$result[1]));
        
        }


        function getEmployeesByBranch($id){
            $data = $this->bds('texto');
        $result = [];
//            print_r($data);
        for ($i = 0; $i < count($data); $i++){
